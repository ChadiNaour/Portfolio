        ...
        <motion.div initial={{opacity: 0}} animate={{ opacity: 1, delay: 4, duration: 4}} className={styles.container}>
            ...
            <main className={styles.main} style={{ backgroundColor: "#0a0c11" }}>
                <motion.div initial={{ opacity: 0 }}
                    ...
                    <div className='hidden xs:block absolute font-reloadLight  text-white text-lg  md:text-2xl pl-6 md:pl-10 z-10 pt-4 -rotate-90'>home</div>
                </motion.div>
                <motion.div initial={{ height: 0 }}
                    ...
                    transition={{
                        ...
                        delay: 3,
                        duration: 1
                    }} className="hidden xs:block absolute z-10 top-1/3 left-0 w-10  bottom-10 ml-7 md:ml-14 border-l-2 border-white">
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0 }}
                    ...
                    transition={{
                        ...
                        delay: 2.5,
                        duration: 2
                    }} className="text-7x mt-2  z-10" style={{ fontSize: "5.13889vw", fontWeight: "700", lineHeight: "1.08" }}>✌️</motion.div>
                ...
                >HI</div>
                <div className="absolute pb-8 pt-2 flex justify-center items-center left-0 bottom-0 z-0 w-full bg-dark " >
            ...
            <main ref={projectsRef} className={styles.main} style={{ backgroundColor: "#0a0c11" }}>
                <motion.div initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{
                        opacity: { ease: "linear" },
                    ...
                    <div className=' absolute font-reloadLight  text-white text-lg  md:text-2xl pl-6 md:pl-10 pt-4 -rotate-90 z-10'>work</div>
                </motion.div>
                <motion.div initial={{ height: 0 }}
                    animate={{ height: "55%" }}
                    transition={{
                        ...
                        delay: 1,
                        duration: 1
                    }} className="absolute top-1/3 left-0 w-10  bottom-10 ml-7 md:ml-14 border-l-2 border-white z-10">
                </motion.div>
                <div className='hidden sm:block absolute z-0 mx-auto p-0 font-timmons md:text-6xl'
                    style={{
                        fontSize: "calc(var(--vh, 1vh) * 75)",
                        // display: "none",
                        color: "#202020",
                        left: "50%",
                        // position: "fixed",
