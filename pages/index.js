  ...
  return (
    <AnimatePresence className={styles.container}>
      ...
      <motion.main initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0, delay: 5, duration: 5 }} className={styles.main} style={{ background: "linear-gradient(190deg, #0A0C11 70%, #323232 120.3%" }}>
        ...
        <motion.div
          className="flex absolute flex-col mt-6 justify-center  text-center " style={{ width: "250px" }}>
          <motion.div initial={{ opacity: 0, y: 10 }}
            ...
            <div className=''>
              <h1 className="font-reloadLight text-white text-lg z-8">
          ...
          <motion.div initial={{ opacity: 0 }}
            ...
            transition={{
              ...
              delay: 5,
              duration: 3
            }} className='flex justify-center mt-6 z-0  h-40'>
      ...
      <motion.div
        ...
        className='absolute cursor-pointer left-0 bottom-0  w-full pb-16 flex justify-center xl:justify-end md:pr-14'>
        <div>
