    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className="flex flex-col justify-center align-center text-center ">
          <h1 className="font-reloadLight text-white text-xl">
            for the better expirience turn up your volume.
          </h1>
          <div>
            <button className="bg-white px-8 w-40 py-4 m-4"><span className='font-reloadLight text-black text-xl'>start</span></button>
          </div>
          {/* <div className="rounded-full w-24 h-24 bg-white d-flex flex justify-center align-center"><svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} viewBox="0 0 384 512"><path d="M374.6 310.6l-160 160C208.4 476.9 200.2 480 192 480s-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 370.8V64c0-17.69 14.33-31.1 31.1-31.1S224 46.31 224 64v306.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0S387.1 298.1 374.6 310.6z"/></svg></div> */}
        </div>
      </main>
