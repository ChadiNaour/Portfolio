  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        >
          <h1 className="blackMirror" data-text="i am chadi naour"><span>i am chadi naour</span></h1>
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
          ...
          className="flex absolute bottom-0 flex-col justify-center  text-center " style={{ width: "250px" }}>
          ...
          <div className='flex justify-center mt-6  h-40'>
            ...
            <Link href="/home">
              <RoundedButton><svg xmlns="http://www.w3.org/2000/svg" fill="black" width={20} height={20} className="ml-4 " viewBox="0 0 448 512"><path d="M438.6 278.6l-160 160C272.4 444.9 264.2 448 256 448s-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L338.8 288H32C14.33 288 .0016 273.7 .0016 256S14.33 224 32 224h306.8l-105.4-105.4c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160C451.1 245.9 451.1 266.1 438.6 278.6z" /></svg></RoundedButton>
            </Link>
          </div>
        </motion.div>
      </main>
      ...
      initial={{ x: 400 }}
        ...
        transition={{
         ...
         className='absolute -right-80 cursor-pointer left-0 bottom-0  w-full pb-16 flex justify-center xl:justify-end md:pr-14'>
        <div>
