    ...
    <>
      ...
      <AnimatePresence className={styles.container}>
        <motion.div initial={{ opacity: 0 }}
          ...
          <motion.div
            className="flex absolute flex-col 2xl:mt-6 justify-center  text-center " style={{ width: "250px" }}>
