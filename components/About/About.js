      ...
      <div className='flex justify-center items-center  flex-col md:flex-row w-full h-full md:w-[90vw] xl:w-[85vw] md:h-[90vh] mt-6 md:mt-0   lg:h-2/3  z-20'>
        ...
        <div className="md:flex md:flex-col lg:mt-0  md:justify-center md:items-center md:h-full md:w-full lg:w-1/3 ">
          <div className='flex flex-col justify-center items-center relative h-auto w-full '>
            ...
            {/* glass card */}
            <div className='-mt-8 2xl:-mt-10 px-8 xl:-mt-10 2xl:-mt-12 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg drop-shadow-lg w-72 sm:w-80 2xl:w-96 h-24 xl:h-28 2xl:h-36 flex justify-center items-center'>
              ...
              <div className="flex justify-center items-center relative transition ease-in-out">
                <span className='text-md 2xl:text-xl text-white font-cinetype mb-5   transition ease-in-out duration-300'>{displayedQuote.text}</span>
                <span className="absolute text-xs xl:text-md text-white right-0 bottom-0 uppercase  transition ease-in-out duration-300">— {displayedQuote.author}</span>
              </div>
