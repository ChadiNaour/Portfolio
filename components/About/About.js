  ...
  return (
    <section ref={AboutRef} className="h-full relative flex z-10  w-full flex flex-col justify-center items-center overflow-hidden bg-dark">
      ...
      <div className='flex justify-center items-center  flex-col md:flex-row w-full h-full md:w-[90vw] xl:w-[85vw] md:h-[90vh] mt-6 md:mt-0   lg:h-2/3  z-20'>
        ...
        {/* right container */}
        <div className="md:flex md:flex-col md:mt-16 lg:mt-0  md:justify-center md:items-center md:h-full md:w-full lg:w-1/3 ">
          <div className='flex flex-col justify-center items-center relative h-auto w-full '>
            {/* emoji div */}
            <div className="-mt-8 sm:-mt-16 2xl:-mt-20 relative w-72 h-72 md:w-[21rem] md:h-[21rem] xl:w-[430px] xl:h-[430px]  2xl:w-[470px] 2xl:h-[470px] ">
              <Image layout="fill" src={Memoji} className="hidden" />
            </div>
            {/* glass card */}
            <div className='-mt-8 2xl:-mt-10 xl:-mt-10 2xl:-mt-11 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg drop-shadow-lg w-72 sm:w-80 2xl:w-96 h-24 xl:h-28 2xl:h-36 flex justify-center items-center'>
