...
const AboutSection = ({ }) => {
  ...
  //   transition: all 100ms cubic-bezier(1.000, -0.195, 0.000, 1.330);
  //   transition-timing-function: cubic-bezier(.17,.67,.77,.58)
  // }

  const Jutton = styled.button`
            position: relative;
            background: white;
            height: 70px;
            width: 200px;
    ...
    <section ref={aboutRef} className="h-screen relative flex z-10  w-full flex justify-center items-center overflow-hidden bg-dark">
      ...
      <div className='grid grid-cols-3 w-4/5  h-2/3  z-20'>
        <div className=' flex  flex-col col-span-2'>
          <div className="w-full h-full relative flex flex-col items-start justify-center bg-green-600">
            <div className=' w-[900px] font-cinetype text-[65px]' style={{ color: "transparent", WebkitTextStroke: "0.02em #fff" }}>HI THERE</div>
            <div className=' w-[900px] font-cinetype text-[40px] text-white leading-tight'>I am a self taught passionate front-end web developer based in casablanca morroco, i use react / next, redux, javascript / typescript, css and it’s frameworks to create clean, functional and interactive experiences </div>
            <Jutton className='mt-8'>
              <span className='cotet z-20 font-reloadLight mt-1 text-sm lg:text-xl xl:text-[23px] flex flex-row items-center'>RESUME<svg xmlns="http://www.w3.org/2000/svg" className="arrow ml-4 pb-1 w-7 h-7" viewBox="0 0 448 512"><path d="M438.6 278.6l-160 160C272.4 444.9 264.2 448 256 448s-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L338.8 288H32C14.33 288 .0016 273.7 .0016 256S14.33 224 32 224h306.8l-105.4-105.4c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160C451.1 245.9 451.1 266.1 438.6 278.6z" /></svg></span>
            </Jutton>
          </div>
          {/* <div className='h-1/5 pl-10 bg-red-200'>
            <Jutton>
              <span className='cotet z-20 font-reloadLight mt-1 text-sm lg:text-xl xl:text-[23px] flex flex-row items-center'>RESUME<svg xmlns="http://www.w3.org/2000/svg" className="arrow ml-4 pb-1 w-7 h-7" viewBox="0 0 448 512"><path d="M438.6 278.6l-160 160C272.4 444.9 264.2 448 256 448s-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L338.8 288H32C14.33 288 .0016 273.7 .0016 256S14.33 224 32 224h306.8l-105.4-105.4c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160C451.1 245.9 451.1 266.1 438.6 278.6z" /></svg></span>
            </Jutton>
          </div> */}
        </div>
        <div className=" flex flex-col justify-center items-center relative col-span-1 bg-blue-500">
          <div className="absolute -top-3">
            <Image layout="fixed" width={520} height={520} src={Memoji} />
          </div>
          <div className='absolute bottom-10 bg-white bg-opacity-20 backdrop-blur-lg rounded-lg drop-shadow-lg w-[400px] h-40 flex justify-center items-center'>
