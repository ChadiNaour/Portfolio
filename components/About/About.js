      ...
      <div className='flex justify-center items-center  flex-col lg:flex-row w-full h-full md:w-[90vw] xl:w-[85vw] md:h-[90vh] mt-6 md:mt-0   lg:h-2/3  z-20'>
        ...
        <div className='p-4 md:pr-8 flex  flex-col  w-full lg:w-2/3'>
          <div className="w-full h-full relative flex flex-col items-center lg:items-start justify-center ">
            <div className='font-cinetype text-[1.6rem] md:text-3xl xl:text-4xl 2xl:text-5xl md:mb-2 xl:mb-2' style={{ color: "transparent", WebkitTextStroke: "0.02em #fff" }}>HI THERE</div>
            <div className='font-cinetype text-center lg:text-left text-lg sm:text-2xl xl:text-3xl 2xl:text-[1.9rem]  text-white leading-normal md:text-[1.3rem] md:leading-wider lg:leading-tight xl:leading-tight 2xl:leading-normal tracking-tight md:tracking-normal lg:tracking-wide mb-3 xl:mb-6'>I'm a passionate Front-end web developer, I specialize in designing and developing clean, functional and interactive user experiences, I'm quietly confident, fast learner, and perpetually working on improving myself.</div>
            {/* main stack responsive */}
            <button onClick={(e) => {
              e.preventDefault();
              setModal(!modal);
            }} className='md:hidden hover:text-graye w-full text-center text-white font-reloadLight underline mb-3'>see my Main Stack</button>
            {/* main stack */}
        ...
        <div className=" lg:flex lg:flex-col lg:mt-0 lg:justify-center lg:items-center lg:h-full md:w-full lg:w-1/3 ">
          <div className='flex flex-col justify-center items-center relative h-auto w-full '>
            {/* emoji div */}
            <div className="-mt-8 lg:-mt-16 2xl:-mt-24 relative w-72 h-72 md:w-[21rem] md:h-[21.5rem] xl:w-[430px] xl:h-[440px]  2xl:w-[490px] 2xl:h-[500px] ">
            ...
            <div className='-mt-8 xl:-mt-11 px-10 xl:-mt-10 2xl:-mt-12 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg drop-shadow-lg w-72 sm:w-80 xl:w-96 h-28 xl:h-36 2xl:h-40 flex justify-center items-center'>
              ...
              <div className='absolute bottom-0 right-0 w-1/2 h-10 flex items-center justify-end pr-[5%] pb-[2%]'>
                <span className="text-xs xl:text-md text-white uppercase  transition ease-in-out duration-300">— {displayedQuote.author}</span>
              </div>
            </div>
          </div>
        </div>
