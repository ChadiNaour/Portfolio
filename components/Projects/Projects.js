...
const ProjectsSection = ({ }) => {
    ...
    return (
        <section className="h-full w-auto overflow-visible relative flex flex-row z-10 bg-dark">
            ...
            >PROJECTS</div>
            <div className='hidden md:block absolute z-0 mx-auto p-0 font-timmons md:text-6xl sm:hidden'
                style={{
                        ...
                        <div className={`w-screen h-full flex justify-center z-20 items-center`}>
                            <div className='w-[90%] xs:w-[22rem] h-[34rem] md:w-[90vw] lg:w-3/4 xl:w-3/5 md:h-[27rem] lg:h-[27rem] xl:h-[27rem] 2xl:h-[30rem] 3xl:w-1/2 3xl:h-[49rem] z-20 rounded-md md:rounded-sm relative flex flex-col items-center shadow-2xl bg-[#2B2B2B]' key={index}>
                                ...
                                <div className='h-[15%]  md:h-1/6 w-full flex justify-center flex-row md:justify-end'>
                                    <div className="h-full  md:w-1/2 xl:w-1/3 flex md:justify-end items-center md:items-start  mx-4  md:mr-7 xl:mr-10">
