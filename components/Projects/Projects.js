...
const ProjectsSection = ({ }) => {
    ...
    return (
        <section className="h-full w-auto overflow-visible relative flex flex-row z-10 bg-dark">
                ...
                {Projects.map((project, index) => (
                    <SwiperSlide key={index}>
                        <div className={`w-screen h-full flex justify-center z-20 items-center`}>
                            <div className='w-[90%] xs:w-[25rem] h-[40rem] md:w-[90vw] lg:w-3/4 xl:w-3/5 md:h-[27rem] lg:h-[27rem] xl:h-[27rem] 2xl:h-[40vh] 3xl:w-1/2 3xl:h-[40vh] z-20 rounded-md md:rounded-lg relative flex flex-col items-center shadow-2xl bg-[#2B2B2B]' key={index}>
                                <div className="h-[10%] md:h-1/6 xl:h-1/5 w-full ">
                                    <div className="absolute  right-0 mr-5 mt-5 lg:mr-6 xl:mr-8 xl:mt-8  top-0"><span className='text-white text-xl xl:text-2xl font-reloadLight'>{index + 1} / 5</span></div>
                                </div>
                                <div className="h-[75%] pt-4  md:pt-0 md:h-2/3 w-full md:px-12 xl:px-20  flex flex-col md:flex-row justify-start md:justify-center xl:justify-start items-center">
                                    <div className="relative bg-gray-400 h-48 w-48 md:h-[18rem] md:w-[18rem] 2xl:h-[26.6vh] 2xl:w-[26.6vh] flex justify-center items-center">
                                        <Image layout="fill" src={project.image} />
                                    </div>
                                    <div className="md:h-full md:h-full w-full md:w-2/3 xs:px-6 flex flex-col justify-start pt-[1%] xl:pt-[2%]">
                                        <span className='text-white text-center md:text-left  font-reloadBold text-[1.7em] md:text-3xl lg:text-[2.1rem] xl:text-[2rem] 2xl:text-[2.4rem] 3xl:text-[2.6rem] md:ml-6 xl:ml-12 tracking-wider lg:mb-2'>{project.name}</span>
                                        <span className='text-gray-50 text-center md:text-left font-cinetype text-xl md:text-xl lg:text-[1.35rem] xl:text-[1.45rem] 2xl:text-[1.7rem] 3xl:text-[2rem] px-3 md:px-0 md:ml-6 xl:ml-12 leading-normal md:leading-normal lg:leading-norm xl:leading-normal 2xl:leading-normal tracking-wider'>{project.description}</span>
                                        <div className="w-auto z-50  flex flex-row gap-3 md:gap-5 justify-center md:justify-start  items-center md:ml-6 xl:ml-12 mt-4 md:mt-6">
                                            {project.stack.map((stack, index) => (
                                                <div key={index} className='w-auto z-50 relative group cursor-pointer flex justify-center items-center' >
                                                    {stack.name !== "Simple DirectMedia Layer" ? <Icon className='z-50 h-8 w-8 lg:h-9 lg:w-9 xl:h-10 xl:w-10 2xl:w-12 2xl:h-12 3xl:w-13 3xl:h-13' key={index} icon={stack.icon} style={{ color: "white" }} /> : <svg className='z-50 h-8 w-8 lg:h-9 lg:w-9 xl:h-10 xl:w-10 2xl:w-12 2xl:h-12 3xl:w-13 3xl:h-13' xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32"><path fill="white" d="M18.787 27.148H9.672l7.213-18.755h3.454l-5.902 15.345h5.683l-1.333 3.41zM2 19.344l1.2-3.3a4.129 4.129 0 0 0 1.53 1.137a4.89 4.89 0 0 0 1.989.372a5.9 5.9 0 0 0 1.137-.109a3.6 3.6 0 0 0 .9-.306a1.8 1.8 0 0 0 .634-.481a1.685 1.685 0 0 0 .372-.59A1.172 1.172 0 0 0 9.8 15.3a1.66 1.66 0 0 0-.437-.634a5.171 5.171 0 0 0-.809-.568c-.328-.175-.678-.372-1.071-.546a3.814 3.814 0 0 1-1.945-1.771a3.349 3.349 0 0 1 .066-2.514a6.006 6.006 0 0 1 1.18-1.989A6.879 6.879 0 0 1 8.557 5.9a8.121 8.121 0 0 1 2.143-.785a10.318 10.318 0 0 1 2.317-.262a13.481 13.481 0 0 1 2.011.131a5.655 5.655 0 0 1 1.486.437L15.4 8.5a2.5 2.5 0 0 0-.656-.459a4.246 4.246 0 0 0-.787-.328a6 6 0 0 0-.852-.2a6.317 6.317 0 0 0-1.924.066a3.6 3.6 0 0 0-.9.306a2.534 2.534 0 0 0-.678.481a1.834 1.834 0 0 0-.393.612a.992.992 0 0 0-.044.656a1.606 1.606 0 0 0 .35.568a3.877 3.877 0 0 0 .7.525a10.049 10.049 0 0 0 .984.525a7.434 7.434 0 0 1 1.311.787a3.531 3.531 0 0 1 .874.94a2.2 2.2 0 0 1 .328 1.2a4.528 4.528 0 0 1-.306 1.574a5.876 5.876 0 0 1-1.224 2.077a6.589 6.589 0 0 1-1.771 1.355a7.771 7.771 0 0 1-2.142.743a11.943 11.943 0 0 1-2.339.219a12.16 12.16 0 0 1-2.251-.2A5.027 5.027 0 0 1 2 19.344Z" /><path fill="white" d="m17.738 17.2l-1.049 2.71h1.989a10.989 10.989 0 0 0 6.492-2.077a11.394 11.394 0 0 0 4.175-5.53q2.623-7.213-5.268-7.213h-5.246l-.984 2.71h4.984a3.319 3.319 0 0 1 2.995 1.224a3.706 3.706 0 0 1 .022 3.322a7.675 7.675 0 0 1-2.514 3.541a6.179 6.179 0 0 1-3.869 1.313h-1.727" /></svg>}
                                                    <span className="inline-block font-cinetype absolute scale-0 w-auto group-hover:scale-100 -bottom-12 z-50 py-2 px-3 text-sm text-white bg-[#212121] border-[1px] border-white rounded-lg shadow-sm duration-300">
                                                        {stack.name}
                                                    </span>
                                                </div>
                                            ))}
                                ...
                                <div className='h-[15%]   md:h-1/6 xl:h-1/5 w-full flex justify-center flex-row md:justify-end'>
                                    <div className="h-full  md:w-1/2 xl:w-1/3 flex md:justify-end items-center md:items-center xl:items-start md:mr-7  md:pb-4 mx-4 xl:mr-10">
            ...
            {/* </motion.div> */}
            <div className="absolute z-20  pb-4 pt-2 flex justify-center items-center left-0 bottom-0 font-reloadLight text-graye w-full text-sm lg:text-[1rem]  select-none" >
