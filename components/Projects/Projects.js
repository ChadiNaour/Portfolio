                ...
                {Projects.map((project, index) => (
                    <SwiperSlide key={index}>
                        <div className={`w-screen h-full flex justify-center z-20 items-center`}>
                            <div className='w-[90%] h-[70vh] md:w-[90vw] lg:w-3/4 xl:w-3/5 md:h-[45vh] lg:h-[45vh] xl:h-[47vh] z-20 rounded-md md:rounded-lg relative flex flex-col items-center shadow-2xl bg-[#2B2B2B]' key={index}>
